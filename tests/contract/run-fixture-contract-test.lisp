...
(test run-fixture-contract
  (let* ((result (cl-cc.services:run-fixture "test"))
    ...
    (is (string= (cl-cc.lib:result-message result)
                 "[SUCCESS] tool:echo-tool result:fixture-input-test"))
  ...
  (let* ((multiple-result (cl-cc.services:run-fixtures '("test" "fail")))
    ...
    (is (string= (cl-cc.lib:result-message multiple-result)
           (format nil "test: [SUCCESS] tool:echo-tool result:fixture-input-test~%fail: [SUCCESS] tool:echo-tool result:fixture-input-fail")))
