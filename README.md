...
- Output Schema: `text`: edit summary; `json`: `result`, `path`, `preview`, `matchCount`, `totalMatches`, `selectedOccurrence`, `matchStart`, `matchEnd`, `matchedText`, `replacementText`, `beforePreview`, `afterPreview`, `diffPreview`, `writeApplied` [closed]
- Output JSON Fields:
